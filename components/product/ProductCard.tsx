...
export default function ProductCard(product : Product & { category: string }) {
    ...
    return (
        <>
                <div
                    key={product.id}
                    className="bg-white rounded-4xl p-3 md:p-4 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all group border border-slate-100/80 hover:border-pink-100/80 flex flex-col relative z-0"
                >
                    {/* Imagem do Produto */}
